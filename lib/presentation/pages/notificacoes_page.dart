...
class _NotificacoesPageState extends State<NotificacoesPage> {
  ...
  void _onSearchChanged() {
    ...
    setState(() {
      _notificacoesFiltradas = _viewModel.notificacoes.where((n) {
        final produto = n.produto_nome.toLowerCase();
        final solicitante = n.solicitante_nome.toLowerCase();
        final cargo = n.solicitante_cargo.toLowerCase();
  ...
  Future<void> _markAsRead(Notificacao notificacao) async {
    final success = await _viewModel.markAsRead(
        notificacao.id_notificacao); // Changed from id to idNotificacao
    if (success) {
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Card(
                                  ...
                                  child: ListTile(
                                    ...
                                    title: Text(
                                      '${notificacao.solicitante_nome} solicitou ${notificacao.quantidade} unidades de ${notificacao.produto_nome}',
                                      style: TextStyle(
                                    ...
                                    subtitle: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          'Cargo: ${notificacao.solicitante_cargo}',
                                          style: TextStyle(
                                              color: Colors.grey[600]),
                                        ),
                                        Text(
                                          'Data: ${DateFormat('dd/MM/yyyy HH:mm').format(notificacao.data_solicitacao)}',
                                          style: TextStyle(
                                              color: Colors.grey[600]),
                                        ),
                                      ],
